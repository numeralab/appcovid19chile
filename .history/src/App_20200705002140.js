        ...
        return (
            ...
            <Zoom>
                ...
                <ScrollAnimation animateIn='fadeIn' animateOut='fadeOut'>
                    ...
                    <p>La aplicación fue desarrollada en un principio por <a className={styles.enlacefuente} href="youtube.com/javascriptmastery">JavaScript Mastery</a>, se sustenta en las fuentes de <a className={styles.enlacefuente} href="https://covid19.mathdro.id/">la API de COVID19 de MathDro</a> y posteriormente fue modificada por <a className={styles.enlacefuente} href="linkedin.com/alejandrodinamarca"> </p>
                </ScrollAnimation>
            </div>
        )
    }
