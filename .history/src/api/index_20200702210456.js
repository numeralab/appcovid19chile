...
export const fetchData = async (provincia) => {
    ...
    if (provincia) {
        ...
        try {
            ...
            const {data: [confirmed = provincias[10].confirmed, recovered = provincias[10], deaths = provincias[10].deaths, lastUpdate = provincias[10]  ] } = await axios.get(`${url}/confirmed`);
            console.log(provincias[10].deaths.value);
            return {
                confirmed,
                recovered,
                deaths,
