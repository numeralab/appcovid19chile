...
export const fetchData = async (provincia) => {
    ...
    if (provincia) {
        ...
        try {
            ...
            console.log({});
            return {
                confirmed: Metropolitana.confirmed.value,
                recovered: Metropolitana.recovered.value,
                deaths: Metropolitana.deaths.value,
                lastUpdate: Metropolitana.lastUpdate.value,
            };
        } catch (error) {
            return error;
        }
