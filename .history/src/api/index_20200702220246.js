...
export const fetchData = async (provincia) => {
    ...
    if (provincia) {
        ...
        try {
            ...
            const {
                data: {
                    confirmed = parseInt(provincias[2].confirmed),
                    recovered = parseInt(provincias[2].recovered),
                    deaths = parseInt(provincias[2].deaths),
                    lastUpdate = provincias[2].lastUpdate
                }
