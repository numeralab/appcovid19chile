...
export const fetchData = async (provincia) => {
    ...
    if (provincia) {
        ...
        try {
            ...
            const {data: [confirmed = provincias[1].confirmed, recovered = provincias[1].recovered, deaths = provincias[1].deaths, lastUpdate = provincias[1].lastUpdate  ] } = await axios.get(`${url}/confirmed`);
