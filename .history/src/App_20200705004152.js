        ...
        <div className={styles.container}>
            <Zoom>
                ...
                <Zoom>
                    ...
                    linkedin.com / alejandrodinamarca ">Alejandro Dinamarca</AnimationWrapper>
                    <Chip label="Alejandro Dinamarca" color="secondary" avatar={<Avatar src="/static/images/avatar/1.jpg" />} />
                    <AnimationWrapper> para Chile y regiones específicas del país tras un tiempo de 18 hrs. Espero sea de utilidad y pueda proveer de información en tiempo real para la ciudadanía. </p>
                    </AnimationWrapper>
                    <AnimationWrapper>
