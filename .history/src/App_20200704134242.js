...
import {Cards, Chart, CountryPicker, Typography} from './components';
    ...
    render() {
        ...
        return (
            ...
            <Zoom>
                ...
                <h4 className={styles.fuente}>Las cifras a continuación son de <a className={styles.enlacefuente} href="https://covid19.mathdro.id/">fuente internacional</a>.</h4>
                
                <Cards data={data} />
            </Zoom>
                <Typography>Las regiones están ordenadas por número de casos totales.</Typography>
