        ...
        <div className={styles.container}>
            <Zoom>
                ...
                <Zoom>
                    ...
                    <p className = {
                        styles.fuente
                    } > La aplicación fue desarrollada en un principio por < a className = {
                        styles.enlacefuente
                    }
                    href = "youtube.com/javascriptmastery" > JavaScript Mastery < /a> y se sustenta en las fuentes de <a className={styles.enlacefuente} href="https:/ / covid19.mathdro.id / "> la API de COVID19 de MathDro</a>. Posteriormente fue modificada por <AnimationWrapper><a className={styles.enlacefuente} href="
                    linkedin.com / alejandrodinamarca ">Alejandro Dinamarca</a></AnimationWrapper> para Chile y regiones específicas del país tras un tiempo de 18 hrs. Espero sea de utilidad y pueda proveer de información en tiempo real para la ciudadanía. </p>
                    <p className={styles.contacto}>La visualización de datos empodera las decisiones con inteligencia. Usémosla y seamos conscientes de que de nosotros depende que la pandemia no escale. Cuídemonos en medida de lo posible y salgamos adelante. :)</p>
                </Zoom>
        </div>
        )
    }
