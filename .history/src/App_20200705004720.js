        ...
        <div className={styles.container}>
            <Zoom>
                ...
                <Zoom>
                    ...
                    <AnimationWrapper>
                    <Chip label="Alejandro Dinamarca" color="secondary" avatar={<Avatar src="../images/imglogopeq.png" />} />
                    </AnimationWrapper>
                    <AnimationWrapper><p> para Chile y regiones específicas del país tras un tiempo de 18 hrs. Espero sea de utilidad y pueda proveer de información en tiempo real para la ciudadanía. </p>
                    </AnimationWrapper>
                    <AnimationWrapper>
