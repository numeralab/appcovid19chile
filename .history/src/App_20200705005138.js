        ...
        <div className={styles.container}>
            <Zoom>
                ...
                <Zoom>
                    ...
                    <AnimationWrapper>
                    <Chip className={styles.chipp} label="Alejandro Dinamarca" color="secondary" avatar={<Avatar src={imagen} />} />
                    </AnimationWrapper>
                    <AnimationWrapper><p className={styles.contacto}>. La aplicación obtiene los datos de Chile y sus regiones, esto tomó un trabajo de 18 hrs.; espero sea de utilidad y pueda proveer de información en tiempo real para la ciudadanía. </p>
                    </AnimationWrapper>
                    <AnimationWrapper>
