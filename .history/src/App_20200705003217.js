        ...
        <div className={styles.container}>
            <Zoom>
                ...
                <Zoom>
                    ...
                    <p className={contacto}>La visualización de datos empodera las decisiones con inteligencia. Usémosla y seamos conscientes de que de nosotros depende que la pandemia no escale. Cuídemonos en medida de lo posible y salgamos adelante. :)</p>
                </Zoom>
        </div>
        )
    }
